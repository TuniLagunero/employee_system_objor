...
employees = [
    ...
    {
        'code':1,
        'name':"Lagunero, Anthony Joshua H.",
        'contact':'09275693522',
...
def home(request):
    ...
    context = {
        'page_title':'Home',
        'employees':'employees',
        'total_department':len(Department.objects.filter(status__exact='1')),
        'total_position':len(Position.objects.all()),
        'total_employee':len(Employees.objects.filter(status__exact='1')),
    }
